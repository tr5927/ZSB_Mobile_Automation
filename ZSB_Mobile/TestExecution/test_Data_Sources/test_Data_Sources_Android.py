...
# data_sources_page.verifyFilePresentInList(removed_file_name, "Google Drive")
# """One Drive"""
# removed_file_name = data_sources_page.remove_File_Based_On_DataSource("One Drive", None, True, True)
# data_sources_page.searchName("")
# data_sources_page.searchName(removed_file_name)
# sleep(2)
# common_method.swipe_screen([0.22037037037037038, 0.3482905982905983], [0.9, 0.3482905982905983], 3)
# try:
#     data_sources_page.verifyFilePresentInList(removed_file_name, "One Drive")
# except:
#     print("File not removed")
# sleep(2)
# data_sources_page.remove_File_Based_On_DataSource("One Drive")
# data_sources_page.verifyFilePresentInList(removed_file_name, "One Drive")
