...
class App_Settings_Screen:
    ...
    def __init__(self, poco):
        ...
        # self.PrinterName_In_Printer_Settings = Template(r"tpl1704389359227.png", record_pos=(0.1, -0.774),resolution=(1080, 2400))
        self.PrinterName_In_Printer_Settings = "ZSB-DP12_2\nTab 2 of 3"
        self.WiFi_Tab = "Wi-Fi"
