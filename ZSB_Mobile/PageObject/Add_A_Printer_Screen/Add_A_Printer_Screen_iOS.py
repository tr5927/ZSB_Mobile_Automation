...
class Add_A_Printer_Screen_iOS:
    ...
    def __init__(self, poco):
        ...
        self.Connect_Wifi_Network_Text = (
            Template(r"tpl1707286425683.png", record_pos=(0.026, -0.911), resolution=(1080, 2400)))
        self.Select_Button_on_Select_Your_Printer = "Select"
        self.Connect_Btn_On_Connect_Wifi_Network_Screen = "Connect"
        self.Password_Field_On_Join_Network = (
            Template(r"tpl1707135468156.png", record_pos=(0.006, 0.084), resolution=(1080, 2400)))
        # """""""""""""""""""""""""""""""""""""""""""""""done"""""""""""""""""""""""""""""""""""""""""""""
        ...
        self.Design_Preview_With_Details = Template(os.path.join(os.path.expanduser('~'),
                                                                 "Pictures\Automation_Backup\ZSB_Automation\ZSB_Mobile\Images",
                                                                 "tpl1707902210476.png"), record_pos=(0.047, 0.202), resolution=(1170, 2532))
